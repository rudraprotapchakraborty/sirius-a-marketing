    ...
    <div className="relative">
      ...
      >
        {relatedPosts.map((post) => (
          <Card
            key={post.id}
            className="w-80 flex-shrink-0 border-cobalt-glow/20 bg-cobalt/10 scroll-snap-align-start"
          >
            <Link href={`/blog/${post.slug}`}>
              ...
              <CardContent className="p-4">
                <Badge className="mb-2 bg-cobalt">{post.category}</Badge>
      ...
      <Button
        variant="outline"
        size="icon"
        className={`absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 bg-cobalt/50 hover:bg-cobalt/75 ${
      ...
      <Button
        variant="outline"
        size="icon"
        className={`absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 bg-cobalt/50 hover:bg-cobalt/75 ${
